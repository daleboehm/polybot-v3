...
.scoreboard { background: #1a1f2e; border: 2px solid #f6ad55; border-radius: 12px; padding: 20px; margin-bottom: 24px; display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 16px; position: sticky; top: 60px; z-index: 999; box-shadow: 0 4px 16px rgba(0,0,0,0.4); }
